...
class MissionOrder(Choice):
    ...
    Vanilla (22): Keeps the standard mission order and branching from the HotS Campaign.
    Vanilla Shuffled (22): Keeps same branching paths from the HotS Campaign but randomizes the order of missions within.
...
class ShuffleNoBuild(DefaultOnToggle):
    """Determines if the 4 no-build missions are included in the shuffle if Vanilla or Vanilla Shuffled mission order is not enabled.
...
#class IncludeAllSpearOfAdunAbilities(Toggle):
#    """If turned on, all passive abilities from every Spear of Adun ability tier will be able to appear.
...
#    display_name = "Include All Spear Of Adun Abilities"
...
#class StartSpearOfAdunAbilities(Range):
#    """Number of Spear of Adun Abilities (Spear of Adun Tier 1, 2, 4, and 6) to start the game with.
#    """
#    display_name = "Starting Spear Of Adun Abilities"
#    range_start = 0
#    range_end = 4
#    default = 0
...
#    "Include_all_Spear_Of_Adun_Abilities": IncludeAllSpearOfAdunAbilities,
#    "Start_Spear_Of_Adun_Abilities": StartSpearOfAdunAbilities,
