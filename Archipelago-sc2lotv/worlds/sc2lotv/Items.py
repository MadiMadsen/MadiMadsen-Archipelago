...
class StarcraftLotVItem(Item):
    game: str = "Starcraft 2 Leagcy of the Void"
...
item_table = {
    ...
    "Stalker": ItemData(1 + SC2LOTV_ITEM_ID_OFFSET, "Unit", 1, classification=ItemClassification.progression),
    "Dark Templar": ItemData(2 + SC2LOTV_ITEM_ID_OFFSET, "Unit", 2, classification=ItemClassification.progression),
    "Sentry": ItemData(3 + SC2LOTV_ITEM_ID_OFFSET, "Unit", 3, classification=ItemClassification.progression),
    "Immortal": ItemData(4 + SC2LOTV_ITEM_ID_OFFSET, "Unit", 4, classification=ItemClassification.progression),
    "Phoenix": ItemData(5 + SC2LOTV_ITEM_ID_OFFSET, "Unit", 5, classification=ItemClassification.progression),
    "High Templar": ItemData(6 + SC2LOTV_ITEM_ID_OFFSET, "Unit", 6, classification=ItemClassification.progression),
    "Void Ray": ItemData(7 + SC2LOTV_ITEM_ID_OFFSET, "Unit", 7, classification=ItemClassification.progression),
    "Colossus": ItemData(8 + SC2LOTV_ITEM_ID_OFFSET, "Unit", 8, classification=ItemClassification.progression),
    "Carrier ": ItemData(9 + SC2LOTV_ITEM_ID_OFFSET, "Unit", 9, classification=ItemClassification.progression),
    "Photon Cannon": ItemData(10 + SC2LOTV_ITEM_ID_OFFSET, "Unit", 10, classification=ItemClassification.progression),
    "Khaydarin monolith": ItemData(11 + SC2LOTV_ITEM_ID_OFFSET, "Unit", 11, classification=ItemClassification.progression),
    ...
    "Progressive Ground Armor": ItemData(101 + SC2LOTV_ITEM_ID_OFFSET, "Upgrade", 2, quantity=3),
    "Progressive Shields": ItemData(103 + SC2LOTV_ITEM_ID_OFFSET, "Upgrade", 4, quantity=3),
