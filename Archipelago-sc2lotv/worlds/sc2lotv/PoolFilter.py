...
from .MissionTables import no_build_regions_list, starter_regions_list, easy_regions_list, medium_regions_list, \
    hard_regions_list, \
...
# ]
UPGRADABLE_ITEMS = [
    #   "Melee Warrior", "Ranged Warrior", "Cloaked Warrior", "Robotic Support", "Psionic Warrior",
    #   "Robotic Assault", "Robotic Siege",
    #   "Starfighter", "Assault Ship", "Capital Ship"
    #"Zealot", "Stalker", "Dark Templar", "Sentry", "High Templar"
    #"Immortal", "Colossus"
    #"Phoenix", "Void Ray", "Carrier"
]

#GATEWAY_UNITS = {"Melee Warrior", "Ranged Warrior", "Cloaked Warrior", "Robotic Support", "Psionic Warrior"}
#ROBOTICS_FACILITY_UNITS = {"Robotic Assault", "Robotic Siege"}
#STARGATE_UNITS = {"Starfighter", "Assault Ship", "Capital Ship"}
GATEWAY_UNITS = {"Zealot", "Stalker", "Dark Templar", "Sentry", "High Templar"}
ROBOTICS_FACILITY_UNITS = {"Immortal", "Colossus"}
STARGATE_UNITS = {"Phoenix", "Void Ray", "Carrier"}
...
def filter_missions(multiworld: MultiWorld, player: int) -> Dict[int, List[str]]:
    ...
    if mission_order_type == 0:
        ...
        mission_pools[MissionPools.FINAL] = ['Salvation']
    ...
    if mission_count < 13:
        final_mission = multiworld.random.choice(
            [mission for mission in alt_final_mission_locations.keys() if mission not in excluded_missions])
        excluded_missions.add(final_mission)
    else:
        final_mission = 'Salvation'
    # Excluding missions
...
class ValidInventory:
            ...
            if item in cascade_keys:
                ...
                if cascade_failure:
                    for transient_item in transient_items:
                        ...
                        if transient_item.classification in (
    ...
    def _read_logic(self):
        self._sc2lotv_has_common_unit = lambda world, player: SC2LotVLogic._sc2lotv_has_common_unit(self, world, player)
        self._sc2lotv_has_air = lambda world, player: SC2LotVLogic._sc2lotv_has_air(self, world, player)
        self._sc2lotv_has_anti_air = lambda world, player: SC2LotVLogic._sc2lotv_has_anti_air(self, world, player)

        #self._sc2lotv_has_minimal_antiair = lambda world, player: SC2lotvLogic._sc2lotv_has_minimal_antiair(self, world,
        #                                                                                                    player)
        # self._sc2lotv_has_brood_lord = lambda world, player: SC2lotvLogic._sc2lotv_has_brood_lord(self, world, player)
        # self._sc2lotv_has_viper = lambda world, player: SC2lotvLogic._sc2lotv_has_viper(self, world, player)
        # self._sc2lotv_has_impaler_or_lurker = lambda world, player: SC2lotvLogic._sc2lotv_has_impaler_or_lurker(self,
        #                                                                                                        world,
        #                                                                                                        player)
        #self._sc2lotv_has_competent_comp = lambda world, player: SC2lotvLogic._sc2lotv_has_competent_comp(self, world,
        #                                                                                                  player)
        # self._sc2wol_has_train_killers = lambda world, player: SC2lotvLogic._sc2wol_has_train_killers(self, world, player)
        # self._sc2lotv_can_spread_creep = lambda world, player: SC2lotvLogic._sc2lotv_can_spread_creep(self, world,
        #                                                                                              player)
        #self._sc2lotv_has_competent_defense = lambda world, player: SC2lotvLogic._sc2lotv_has_competent_defense(self,
        #                                                                                                        world,
        #                                                                                                        player)
        # self._sc2wol_survives_rip_field = lambda world, player: SC2lotvLogic._sc2wol_survives_rip_field(self, world, player)
        # self._sc2wol_has_protoss_common_units = lambda world, player: SC2lotvLogic._sc2wol_has_protoss_common_units(self, world, player)
        # self._sc2wol_has_protoss_medium_units = lambda world, player: SC2lotvLogic._sc2wol_has_protoss_medium_units(self, world, player)
        # self._sc2wol_has_mm_upgrade = lambda world, player: SC2lotvLogic._sc2wol_has_mm_upgrade(self, world, player)
        #self._sc2lotv_has_basic_kerrigan = lambda world, player: SC2lotvLogic._sc2lotv_has_basic_kerrigan(self, world,
        #                                                                                                  player)
        #self._sc2lotv_has_two_kerrigan_actives = lambda world, player: SC2lotvLogic._sc2lotv_has_two_kerrigan_actives(
        #    self, world, player)
        self._sc2lotv_has_low_tech = lambda world, player: SC2LotVLogic._sc2lotv_has_low_tech(self, world, player)
        self._sc2lotv_cleared_missions = lambda world, player, number: SC2LotVLogic._sc2lotv_cleared_missions(self, world, player, number)
...
def filter_items(multiworld: MultiWorld, player: int, mission_req_table: Dict[str, MissionInfo],
